...
- **中国大陆**：无 ICP 备案就在"定价与销售范围"取消勾选中国大陆。上架中国大陆时：ASC「分发 › App 信息 › App Store 法规和许可 › 中国大陆 ICP 备案号」填工信部查询系统里带 `-1A` 后缀的 APP 备案号；简体中文本地化的隐私政策 / 支持 URL 换成 <https://ls.mixduo.cn/privacy> 与 <https://ls.mixduo.cn/support>（github.io 国内打不开，建站与部署见 `docs/release.md`）。
- **欧盟 27 国**：《数字服务法》要求账户先填交易商状态，否则这 27 国显示“未提供交易商状态”且不可销售。2026-09-13 已在“价格与销售范围 › App 供应情况 › 管理供应情况”里取消勾选欧盟 27 国（瑞士、英国、挪威、冰岛不属欧盟，保留），当前 147 国可供应。以后若要上欧盟，先在账户设置里填交易商状态再勾回来。

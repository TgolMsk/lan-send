...
### Added
- 中国大陆 App Store 上架：APP 备案号 `蜀ICP备2026054850号-2A` 已填进 App Store Connect（分发 › App 信息 › App Store 法规和许可 › 中国大陆 ICP 备案号），价格与销售范围里勾上中国大陆（147 → 148 个国家或地区，24 小时内生效），官网部署在备案域名 <https://ls.mixduo.cn/>。简体中文的隐私政策 URL 要等 macOS 0.4.1 出审核（App 信息被审核锁定），技术支持 URL 是版本级字段随下个版本改；过程与剩余步骤记在 `docs/store-listing.md` §二。
